...
public:
	GOLEM_ENGINE_API static inline std::vector<std::unique_ptr<Texture>> m_textures;
...
public:
	...
	GOLEM_ENGINE_API static int ReadPixel(uint32_t _attachmentIndex, int _x, int _y);
