...
matrixX matrixX::GetTranslationMatrix(Vector3 position)
{
	matrixX mat(4);
	mat.mat = {
		1, 0, 0, 0,
...
matrixX matrixX::GetRotationMatrix(Vector3 anglesRad)
{
	matrixX rotationX(4);
	rotationX.mat = {
		1, 0, 0, 0,
...
matrixX matrixX::GetScaleMatrix(Vector3 scale)
{
	matrixX scaleMat(4);
	scaleMat.mat = {
		scale.x, 0, 0, 0,
...
matrixX matrixX::Get_TRS_Matrix(Vector3 position, Vector3 rotaionAngle, Vector3 scale)
{
	matrixX trs(4);
